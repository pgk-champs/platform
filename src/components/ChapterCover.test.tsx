...
test('покрыты все 43 главы', () => {
  expect(CHAPTER_IDS).toHaveLength(44);
});
...
test('новые главы стоят в своих треках', () => {
  const cases = [
    ...
    ['kotlin-vs-java', 'МОБИЛКА', '13'],
    ['kotlin-history', 'МОБИЛКА', '14'],
    ['kotlin-coroutines', 'МОБИЛКА', '11'],
    ['kotlin-null', 'МОБИЛКА', '02'],
    ['first-compose-screen', 'МОБИЛКА', '07'],
    ['ui-kit', 'МОБИЛКА', '10'],
    ['ts-vs-js', 'БЛОКЧЕЙН', '03'],
    ['ts-values', 'БЛОКЧЕЙН', '04'],
    ['ts-flow', 'БЛОКЧЕЙН', '05'],
    ['ts-functions', 'БЛОКЧЕЙН', '06'],
    ['ts-collections', 'БЛОКЧЕЙН', '07'],
    ['ts-oop', 'БЛОКЧЕЙН', '08'],
    ['ts-history', 'БЛОКЧЕЙН', '10'],
    ['ts-async', 'БЛОКЧЕЙН', '09'],
  ] as const;
