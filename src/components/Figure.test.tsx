...
test('имена схем не повторяются между модулями треков', () => {
  ...
  const all = [
    ...
    ...Object.keys(shopDaySchemes),
    ...Object.keys(consoleIoSchemes),
    ...Object.keys(compositionSchemes),
    ...Object.keys(debugSkillSchemes),
    ...
    ...Object.keys(solidityFunctionsSchemes),
    ...
    ...Object.keys(webCssSchemes),
    ...Object.keys(webLayoutSchemes),
    ...Object.keys(webDomSchemes),
    ...Object.keys(webReactSchemes),
    ...
    ...Object.keys(wavesPaymentsSchemes),
    ...
    ...Object.keys(kitCardSchemes),
    ...Object.keys(kitIconFontSchemes),
