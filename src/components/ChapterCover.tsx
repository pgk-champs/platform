...
const CHAPTERS: Record<string, { track: Track; num: string; title: string }> = {
  ...
  'waves-first-network': { track: 'blockchain', num: '11', title: 'Первая сеть на Waves Enterprise' },
  ...
  'ts-flow': { track: 'blockchain', num: '05', title: 'Условия и циклы: как программа принимает решения' },
  'ts-functions': { track: 'blockchain', num: '06', title: 'Функции: как код перестаёт повторяться' },
  'ts-collections': { track: 'blockchain', num: '07', title: 'Массивы и объекты: как хранят много данных сразу' },
  'ts-oop': { track: 'blockchain', num: '08', title: 'ООП на TypeScript: классы, наследование, интерфейсы' },
  'ts-history': { track: 'blockchain', num: '10', title: 'История JavaScript и TypeScript' },
  'ts-async': { track: 'blockchain', num: '09', title: 'Асинхронность: промисы, async/await и цикл событий' },
