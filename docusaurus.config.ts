    ...
    navbar: {
      ...
      items: [
        ...
        },
        {
          ...
          position: 'left',
          items: [
            // Песочница и Слова живут по своим адресам (на них ведут HomeHero
            // и favorites), но из меню убраны: новичка они встречали пустотой.
            // Вход в них — карточками площадок в Зале, где рядом написано,
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Ресурсы',
          items: [
            // Единственный путь к 43 достижениям вёл через дропдаун аватара и
            // только для вошедшего — гостю игрового слоя не существовало,
            // хотя прогресс у него уже копится локально.
            {
              label: 'Достижения',
              to: '/achievements',
            },
