...
<GitSim
  scenario="branches"
  quest={{ title: 'Создай ветку, закоммить в ней и слей её в main', goal: 'merged' }}
...
<GitSim
  scenario="branches"
  quest={{ title: 'Fast-forward против merge-коммита', goal: 'ff-and-merge' }}
  chapterId="git-branches"
...
<GitSim
  scenario="branches"
  quest={{ title: 'Измени одну и ту же строку в двух ветках, получи конфликт при merge и разреши его', goal: 'conflict-resolved' }}
  chapterId="git-branches"
